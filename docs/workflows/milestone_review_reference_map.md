...
STATUS = ACCEPTED
EXACT_ACCEPTED_CONCLUSION = TARGET_42__SECTOR_FIRST_CAPPED_SQUARE_ROOT__GLOBAL_EXCHANGE_AND_LIQUIDITY_MARGINAL_BALANCING__ONE_SECURITY_PER_ISSUER__LEXICOGRAPHIC_HASH_SET_TIE_BREAK__NO_MARKET_CAP
