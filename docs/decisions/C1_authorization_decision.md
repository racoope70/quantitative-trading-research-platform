...
Identify the exact historical 2v entry or range.
Determine materiality.
Review decisive and materially supporting evidence.
Identify superseding corrections.
Separate durable controls from one-time procedures.
Classify retained evidence.
Determine consolidation targets and future-phase relevance.
Propose curated canonical 2v references.
Record technical migration recommendations separately.
...
Every bounded historical section has been reviewed proportionally.
Exact applicable legacy 2v entries or ranges have been identified.
The evidence-retention matrix is complete and accepted.
Durable controls, limitations, and superseding corrections are recorded.
The technical migration manifest is complete and accepted.
The C1 evidence and architecture report is complete and accepted.
No executable migration or other prohibited technical activity occurred.
A risk-proportional independent C1 audit passes after correction of any
material findings.
The owner accepts the C1 completion decision.
